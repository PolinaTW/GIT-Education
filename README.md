...
Убедиться в отсутствии установки на ПК Git с помощью команды в терминале `git --version`. Если терминал покажет наличие Git нужной версии, установка не нужна.   
...
- Выбрать программу Git Bash
- Разрешить использование специального терминала для Git: Integrate Git with the Windows Shell   
