...
**Развернуто**: Git - программа, используемая для контроля версий продуктов IT в процессе их написания и с дальнейшим выбором окончательной версии продукта, которая идет в production. Это широко распространенный инструмент IT. С помощью Git можно контролировать как программный код на любом языке, так и IT-документацию (Git повлиял на разработку документации, породив принцип docs-as-code). Git широко используется во всем мире как система контроля версий.             
