...
**Развернуто**: Git - программа, используемая для контроля версий продуктов IT непосредственно в процессе их написания и с дальнейшим выбором окончательной версии продукта, которая идет в production.         
## **Что обеспечивает GIT**   
Это широко распространенный инструмент,   
- Возможность создания версий
- Возможность коллективной работы над IT-продуктом   
-    
